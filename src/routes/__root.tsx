...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sri Vishnu Consol Pvt Ltd — engineering, construction, scaffolding and project management services across India. CIN U45201KA2012PTC063587." },
