...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sri Vishnu Consol Pvt Ltd — scaffolding, construction, building & interior contractor serving Bangalore, Mysore, Mumbai, Pune, Chennai, Hyderabad, Kolkata, Noida and Mangalore. CIN U45201KA2012PTC063587." },
      { name: "keywords", content: "scaffolding contractor, construction company, building contractor, interior fitout, Bangalore, Mysore, Mumbai, Pune, Chennai, Hyderabad, Kolkata, Noida, Mangalore, Sri Vishnu Consol" },
      { name: "author", content: "Sri Vishnu Consol Pvt Ltd" },
